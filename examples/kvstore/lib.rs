...
#[action]
fn _constructor(bool_value: Boolean, int_value: Integer, string_value: String, address_value: String) {
...
#[action]
fn update_storage(bool_value: Boolean, int_value: Integer, string_value: String, address_value: String) {
    // Check owner
